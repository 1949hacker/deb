% aptdownloader(SECTION) | User Commands
%
% "June 21 2024"
...
aptdownloader - program to do something

# SYNOPSIS

**aptdownloader** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**aptdownloader** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **aptdownloader** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**aptdownloader** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    aptdownloader. See **foo.conf**(5) for further details.
...
**aptdownloader** provides some return codes, that can be used in scripts:
